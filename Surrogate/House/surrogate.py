...
def train_model(X_train, y_train):
    model = MultiOutputRegressor(GradientBoostingRegressor(n_estimators=100, learning_rate=0.05, max_depth=5, min_samples_split=3, min_samples_leaf=2, subsample=0.9, random_state=42))
...
#MSE for 'accuracy', 'f1', 'training_time': 1.232595164407831e-32, 1.232595164407831e-32, 0.0011908430274638906